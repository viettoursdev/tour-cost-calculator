...
export type QuoteViewKey =
  ...
  | 'contract' | 'customer' | 'ncc' | 'nccProducts' | 'flights' | 'workflow' | 'passengers' | 'opsboard' | 'departures' | 'payboard' | 'audit' | 'pipeline' | 'salesanalytics' | 'execboard' | 'advance' | 'process' | 'hr' | 'hrguides' | 'recruit' | 'todo';
