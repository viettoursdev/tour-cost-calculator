...
export type QuoteViewKey =
  ...
  | 'contract' | 'customer' | 'ncc' | 'nccProducts' | 'flights' | 'workflow' | 'passengers' | 'opsboard' | 'departures' | 'payboard' | 'audit' | 'pipeline' | 'salesanalytics' | 'execboard' | 'advance' | 'advsettle' | 'process' | 'hr' | 'todo' | 'tourvisa' | 'inventory';
